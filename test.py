...
if __name__ == '__main__':
    ...
    bandpass = BandpassFilter(original, outer_radius=65, inner_radius=55)
    ifft = IFFT(bandpass)
    Image.show_image(bandpass._title, bandpass._fft_image)
    Image.show_image(ifft._title, ifft._gray_image)

    # lowpass = LowpassFilter(original, inner_radius=65)
    ...
    # highpass = HighpassFilter(low_ifft, outer_radius=50)
