...
if __name__ == '__main__':
    ...
    Image.save_image(lap_bil5._title, lap_bil5._gray_image, dir='clear/')
    lsd_bil5 = LineSegmentDetector(bil5)
    lsd_can_bil5 = LineSegmentDetector(lap_bil5)
    comp_lsd_bil5 = ComposeImage(original, lsd_can_bil5)
    comp_lsd_can_bil5 = ComposeImage(original, lsd_can_bil5)
    Image.save_image(comp_lsd_bil5._title, comp_lsd_bil5._rgb_image, dir='clear/')
    Image.save_image(comp_lsd_can_bil5._title, comp_lsd_can_bil5._rgb_image, dir='clear/')
    ...
    Image.save_image(lap_low._title, lap_low._gray_image, dir='clear/')
    ...
    Image.save_image(comp_lsd_low._title, comp_lsd_low._rgb_image, dir='clear/')
    Image.save_image(comp_lsd_lap_low._title, comp_lsd_lap_low._rgb_image, dir='clear/')
