...
if __name__ == '__main__':
    ...
    #Image.save_image(can._title, can._gray_image, dir='unclear/')
    Image.save_image(bil5._title, bil5._gray_image, dir='unclear/')
    Image.save_image(comp1._title, comp1._rgb_image, dir='unclear/')
    Image.show_image(comp1._title, comp1._rgb_image)

    lsd2 = LineSegmentDetector(low_ifft)
    comp2 = ComposeImage(original2, lsd2)
    Image.save_image(low_ifft._title, low_ifft._gray_image, dir='unclear/')
    Image.save_image(comp2._title, comp2._rgb_image, dir='unclear/')
